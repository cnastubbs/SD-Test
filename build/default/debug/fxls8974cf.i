...
void fxls_init(void) {
    ...
    i2c_read_reg8(0x18, 0x15, &sens_config1);
    sens_config1 |= 0x01;
    ...
    i2c_read_reg8(0x18, 0x16, &sens_config2);
    sens_config2 &= ~(0x01 << 3);
    sens_config2 &= ~(0x01 << 1);
    sens_config2 &= ~(0x01);
    sens_config2 |= (0x01 << 6);
    ...
    0x60; 0x60;
    uint8_t buf_config1;
    i2c_read_reg8(0x18, 0x26, &buf_config1);
    buf_config1 &= ~0x60;;
    i2c_write_reg8(0x18, 0x26, buf_config1);


    uint8_t sens_config3;
    i2c_read_reg8(0x18, 0x17, &sens_config3);
    sens_config3 &= 0x0F;
    ...
    uint8_t int_en;
    i2c_read_reg8(0x18, 0x20, &int_en);
    int_en |= 0x80;
    i2c_write_reg8(0x18, 0x20, int_en);


    uint8_t int_pin_sel;
    i2c_read_reg8(0x18, 0x21, &int_pin_sel);
    int_pin_sel |= 0x80;
    i2c_write_reg8(0x18, 0x21, int_pin_sel);


    uint8_t sens_config4;
    i2c_read_reg8(0x18, 0x18, sens_config4);
    sens_config4 |= 0x01;
