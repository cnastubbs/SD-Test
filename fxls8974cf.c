...
void fxls_init(void) {
    ...
    i2c_read_reg8(FXLS_I2C_ADDR, FXLS_SENS_CONFIG1, &sens_config1);
    ...
    i2c_read_reg8(FXLS_I2C_ADDR, FXLS_SENS_CONFIG2, &sens_config2);
...
//
    ...
    BUF_MODE_MASK 0x60;
    uint8_t buf_config1;
    i2c_read_reg8(FXLS_I2C_ADDR, FXLS_BUF_CONFIG1, &buf_config1);
...
//        
    ...
    i2c_read_reg8(FXLS_I2C_ADDR, FXLS_SENS_CONFIG3, &sens_config3);
    sens_config3 &= 0x0F;
...
//    
    ...
    uint8_t int_en;
    i2c_read_reg8(FXLS_I2C_ADDR, FXLS_INT_EN, &int_en);
    int_en |= 0x80;
...
//    
    ...
    uint8_t int_pin_sel;
    i2c_read_reg8(FXLS_I2C_ADDR, FXLS_INT_PIN_SEL, &int_pin_sel);
    int_pin_sel |= 0x80;
...
//
    ...
    i2c_read_reg8(FXLS_I2C_ADDR, FXLS_SENS_CONFIG4, sens_config4);
